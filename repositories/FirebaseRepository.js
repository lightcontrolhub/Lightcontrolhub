...
class FirebaseRepository {
    ...
    static getInstance(firebaseUrl, deviceId) {
        if (!FirebaseRepository.#instance) {
            FirebaseRepository.#instance = new FirebaseRepository(firebaseUrl, deviceId);
        }
    ...
    constructor(firebaseUrl, deviceId) {
        if (FirebaseRepository.#instance) {
            throw new Error('Use FirebaseRepository.getInstance() instead of new FirebaseRepository()');
        }
